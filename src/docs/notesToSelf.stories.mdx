...
- I used CLI, run a single command to compile Storybook, run interaction tests, take screenshots and upload them to the web ui
...
- Pros:
  ...
  - Clean workflow - Interface --> Story --> UI --> (Interface -->) Story --> UI --> ...
- Cons:
  - Lots of props even now - what about with localizations or more complex pages
